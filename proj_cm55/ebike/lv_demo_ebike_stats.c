...
#include "../../../mtb_shared/lvgl/v9.2.0/src/draw/lv_draw_private.h"
...
static void chart_draw_event_cb(lv_event_t * e)
{
    ...
    lv_area_t a;
    a.x1 = chart_coords.x1 + p.x - w / 2;
    a.x2 = chart_coords.x1 + p.x + w / 2;
    a.y1 = chart_coords.y1;
    a.y2 = chart_coords.y2;
    ...
    a.x1 = chart_coords.x1 + p.x - 100;
    a.x2 = chart_coords.x1 + p.x + 100;
    a.y1 = chart_coords.y2 + 5;
    a.y2 = chart_coords.y2 + 20;
...
static void chart_draw_task_event_cb(lv_event_t * e)
{
    ...
    int32_t fract_upper = (int32_t)(LV_MIN(draw_line_dsc->p1.y, draw_line_dsc->p2.y) - obj_coords.y1) * 255 / full_h;
